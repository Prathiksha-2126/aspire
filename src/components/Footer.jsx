...
export default function Footer() {
  ...
  return (
    <footer className="bg-white pt-12 pb-8 px-5 sm:px-8 md:px-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-8 max-w-6xl mx-auto">
        ...
        <div className="sm:col-span-2 md:col-span-1">
          <a href="/#hero" onClick={(e) => handleHomeNavigation(e, "hero")} className="inline-block">
            <img src="/images/Black AspiRE Logo.png" alt="AspiRE" className="h-14 md:h-20 w-auto object-contain mb-3 hover:opacity-90 transition-opacity cursor-pointer" />
          </a>
          <p className="text-sm mt-3 leading-relaxed" style={textColor}>
            Simplifying construction management, empowering businesses, and driving success with innovative solutions.
          </p>
          <p className="text-xs mt-3 font-semibold whitespace-nowrap" style={textColor}>
            Email:{" "}
        ...
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-3">
            <span className={iconCircle} style={iconBg}><Facebook size={16} color="#045B32" /></span>
          ...
          <div className="flex items-center gap-3">
            <span className={iconCircle} style={iconBg}><Instagram size={16} color="#045B32" /></span>
          ...
          <div className="flex items-center gap-3">
            <span className={iconCircle} style={iconBg}><Linkedin size={16} color="#045B32" /></span>
        ...
        <div className="text-sm" style={textColor}>
          ...
          <a href="tel:+917020858404" className="mt-2 font-semibold block hover:underline cursor-pointer">+91 7020858404</a>
        </div>
        ...
        <div className="text-sm" style={textColor}>
          ...
          <a href="tel:+18155569058" className="mt-2 font-semibold block hover:underline cursor-pointer">+1 815 556 9058</a>
        </div>
      </div>

      <hr className="my-7 max-w-6xl mx-auto" style={{ borderColor: "#775151", opacity: 0.6 }} />
      <p className="text-center text-sm font-semibold" style={{ color: "#906262" }}>
